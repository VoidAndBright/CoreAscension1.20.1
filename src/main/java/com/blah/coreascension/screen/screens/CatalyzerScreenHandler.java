...
public class CatalyzerScreenHandler extends ScreenHandler {
    ...
    public CatalyzerScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf ignoredPacketByteBuf) {
        this(syncId, playerInventory,ScreenHandlerContext.EMPTY);
    }

    public CatalyzerScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
