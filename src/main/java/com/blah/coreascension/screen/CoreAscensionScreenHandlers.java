...
import com.blah.coreascension.screen.screens.PrismaerionFurnaceScreen;
...
public class CoreAscensionScreenHandlers {
    ...
    public static final ScreenHandlerType<PrismaerionFurnaceScreenHandler> PRISMAERION_FURNACE_SCREEN_HANDLER = RegisterScreenHandler("prismaerion_furnace", PrismaerionFurnaceScreenHandler::new);
    ...
    public static void ClientRegisterScreens(){
        ...
        HandledScreens.register(PRISMAERION_FURNACE_SCREEN_HANDLER, PrismaerionFurnaceScreen::new);
    }
}
