...
public class CoreAscensionScreenHandlers {
    ...
    public static final ScreenHandlerType<DimensionalSurgingScreenHandler> CATALYZER_SCREEN_HANDLER = RegisterScreenHandler("catalyzer", DimensionalSurgingScreenHandler::new);
