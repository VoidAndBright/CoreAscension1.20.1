...
public class ReinforcedChestBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public ReinforcedChestBlockEntity(BlockPos pos, BlockState state) {
        super(CoreAscensionBlockEntities.GEM_POLISHING_STATION_BLOCK_ENTITY, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> ReinforcedChestBlockEntity.this.progress;
                    case 1 -> ReinforcedChestBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> ReinforcedChestBlockEntity.this.progress = value;
                    case 1 -> ReinforcedChestBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new ReinforcedChestScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
    ...
    private void craftItem() {
        ...
        ItemStack result = new ItemStack(CoreAscensionItems.RUBY);
    ...
    private boolean hasRecipe() {
        ItemStack result = new ItemStack(CoreAscensionItems.RUBY);
        boolean hasInput = getStack(INPUT_SLOT).getItem() == CoreAscensionBlocks.BLAZE_BRICK.asItem();
