...
public class ExcavatorItem extends ShovelItem
{
    ...
    public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner)
    {
        if (miner instanceof PlayerEntity player)
        {
            ...
            {
                if (world.getBlockState(pos.west()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.east()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                        player.getMainHandStack().getItem().canMine(world.getBlockState(pos.east()), world, pos.east(), player))
                {
                    world.breakBlock(pos.east(), true);
                }
                if (world.getBlockState(pos.west().south()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.west().north()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.east().south()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.east().north()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.south()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.north()).isIn(BlockTags.SHOVEL_MINEABLE) &&
            ...
            else if (player.getHorizontalFacing() == Direction.NORTH || player.getHorizontalFacing() == Direction.SOUTH)
            {
                ...
                if (world.getBlockState(pos.west().up()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.west().down()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.east().up()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.east().down()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.up()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                        player.getMainHandStack().getItem().canMine(world.getBlockState(pos.up()), world, pos.up(), player))
                {
                    world.breakBlock(pos.up(), true);
                }
                if (world.getBlockState(pos.down()).isIn(BlockTags.SHOVEL_MINEABLE) &&
            ...
            else if (player.getHorizontalFacing() == Direction.EAST || player.getHorizontalFacing() == Direction.WEST)
            {
                ...
                if (world.getBlockState(pos.up().south()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.down().south()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.up().north()).isIn(BlockTags.SHOVEL_MINEABLE) &&
                ...
                if (world.getBlockState(pos.down().north()).isIn(BlockTags.SHOVEL_MINEABLE) &&
