...
public class EbonstoneSlabBlock extends SlabBlock
{
    public static final BooleanProperty ACTIVATED = BooleanProperty.of("inactive");

    public EbonstoneSlabBlock(Settings settings)
    {
        super(settings);
    }
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random)
    {
                ...
                world.getBlockState(pos.south()).getBlock() == CoreAscensionBlocks.END_GAS)
        {
            ...
            world.setBlockState(pos, state.with(ACTIVATED, false).with(TYPE, origState.get(TYPE)));
            world.scheduleBlockTick(pos, this, 1);
        }
        ...
        {
            BlockState origState = world.getBlockState(pos);
            world.setBlockState(pos, state.with(ACTIVATED, true).with(TYPE, origState.get(TYPE)));
            world.scheduleBlockTick(pos, this, 1);
        }
    }
}
