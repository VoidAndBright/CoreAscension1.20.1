    ...
    public void onEndTick(MinecraftServer minecraftServer)
    {
        for (ServerWorld world : minecraftServer.getWorlds())
        {
            for (Entity entity : world.iterateEntities())
            {
                ...
                {
                    World eWorld = minecart.getWorld();
                    ...
                    if (eWorld.getReceivedRedstonePower(pos.down()) > 0 &&
                            ...
                            getDirection(eWorld, pos.down()) == Direction.UP)
                    {
                        Vec3d v3 = minecart.getVelocity();
                        minecart.setVelocity(v3.getX(), eWorld.getReceivedRedstonePower(pos.down()) / 7d, v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = minecart.getVelocity();
                        minecart.setVelocity(v3.getX(), -eWorld.getReceivedRedstonePower(pos.up(2)) / 7d, v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = minecart.getVelocity();
                        minecart.setVelocity(-eWorld.getReceivedRedstonePower(pos.east()) / 7d, v3.getY(), v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = minecart.getVelocity();
                        minecart.setVelocity(eWorld.getReceivedRedstonePower(pos.west()) / 7d, v3.getY(), v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = minecart.getVelocity();
                        minecart.setVelocity(v3.getX(), v3.getY(), -eWorld.getReceivedRedstonePower(pos.south()) / 7d);
                    }
                    ...
                    {
                        Vec3d v3 = minecart.getVelocity();
                        minecart.setVelocity(v3.getX(), v3.getY(), eWorld.getReceivedRedstonePower(pos.north()) / 7d);
                    }
                }
                if (entity instanceof BoatEntity boat)
                {
                    World eWorld = boat.getWorld();
                    ...
                    if (eWorld.getReceivedRedstonePower(pos.down()) > 0 &&
                            ...
                            getDirection(eWorld, pos.down()) == Direction.UP)
                    {
                        Vec3d v3 = boat.getVelocity();
                        boat.setVelocity(v3.getX(), eWorld.getReceivedRedstonePower(pos.down()) / 7d, v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = boat.getVelocity();
                        boat.setVelocity(v3.getX(), -eWorld.getReceivedRedstonePower(pos.up(2)) / 7d, v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = boat.getVelocity();
                        boat.setVelocity(-eWorld.getReceivedRedstonePower(pos.east()) / 7d, v3.getY(), v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = boat.getVelocity();
                        boat.setVelocity(eWorld.getReceivedRedstonePower(pos.west()) / 7d, v3.getY(), v3.getZ());
                    }
                    ...
                    {
                        Vec3d v3 = boat.getVelocity();
                        boat.setVelocity(v3.getX(), v3.getY(), -eWorld.getReceivedRedstonePower(pos.south()) / 7d);
                    }
                    ...
                    {
                        Vec3d v3 = boat.getVelocity();
                        boat.setVelocity(v3.getX(), v3.getY(), eWorld.getReceivedRedstonePower(pos.north()) / 7d);
                    }
                }
            }
        }
