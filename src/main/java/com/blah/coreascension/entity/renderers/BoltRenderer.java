...
public class BoltRenderer<T extends Entity & FlyingItemEntity> extends EntityRenderer<T>
{
    ...
    public BoltRenderer(EntityRendererFactory.Context ctx, float scale, boolean lit) {
        super(ctx);
    ...
    public BoltRenderer(EntityRendererFactory.Context context)
    {
